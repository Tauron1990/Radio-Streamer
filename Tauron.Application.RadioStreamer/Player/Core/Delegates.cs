...
namespace Tauron.Application.RadioStreamer.Player.Core
{
    ...
    /// </summary>
    internal delegate void DSPCallBack(IntPtr handle, int channel, int buffer, int Length, int user); //TODO
    // CALLBACK FUNCTION !!!
    ...
    internal delegate void GetSyncCallBack(IntPtr handle, IntPtr channel, int data, int user); //internal
    ...
    internal delegate int StreamCallBack(IntPtr handle, int buffer, int Length, int user); //TODO
    // CALLBACK FUNCTION !!!
