...
namespace Tauron.Application.RadioStreamer.Player.Core
{
	...
	public class ChannelAttributes //really a struct
	{
		...
		public float Frequency 
        {
	        get
	        {
	            return GetValue(BASSAttribute.BASS_ATTRIB_FREQ);
	        }
	        set
	        {
	            SetValue(BASSAttribute.BASS_ATTRIB_FREQ, value);
	        }
        }
	    ...
	    public float Volume 
        {
            get
            {
                return GetValue(BASSAttribute.BASS_ATTRIB_VOL);
            }
            set
            {
                SetValue(BASSAttribute.BASS_ATTRIB_VOL, value);
            } 
        }
	    ...
	    public float Panning
	    {
	        get
	        {
	            return GetValue(BASSAttribute.BASS_ATTRIB_PAN);
	        }
	        set
	        {
	            SetValue(BASSAttribute.BASS_ATTRIB_PAN, value);
	        }
