...
namespace WMAStreamTest
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.label7.Text = "nBASS WMAStreams/Visuals Test";
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			if (result == DialogResult.OK)
			{
				...
				stream = bass.LoadWMAStream(false, openFileDialog1.FileName /*"mms://leppie:42042"*/, 0, 0, 0);
				string[] tags = stream.GetTags();
				trackBar4.Value = 0;
		...
		{
			MessageBox.Show(this, "Stream has ended");
			ChangeTimer(0);
		}

		private void Progress(ChannelBase channel)
		{
			WMAStream stream2 = (WMAStream) channel;
